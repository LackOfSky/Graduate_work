...
//    override fun addedFriendResponse(user: User): Boolean {
//        return defaultFriendResponse(user,Response.ADDED)
//    }
//
//    override fun approvedFriendResponse(user: User): Boolean {
//        return defaultFriendResponse(user,Response.APPROVED)
//    }
//
//    override fun canceledFriendResponse(user: User): Boolean {
//        return defaultFriendResponse(user,Response.CANCELED)
//    }
//
//    override fun rejectedFriendResponse(user: User): Boolean {
//        return defaultFriendResponse(user,Response.REJECTED)
//    }
//
//    override fun deletedFriendResponse(user: User): Boolean {
