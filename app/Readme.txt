...
v0.15.3
 ...
 таск 83. передача медіа-повідомлень між користувачами.
                транспортна логіка.
 ...
 таск 81. reply message. зміщувати список до потрібного повідомлення коли натискаєш на прикріплене reply, та кнопка пролистати вниз
