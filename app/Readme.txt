...
v0.15.3
 ...
 (to check)таск 63. інтерфейс для прикріплення різних типів файлів в повідомлення
            відображення різних типів файлів в чаті та їх розподілення
 (to check)таск 64. можливість відтворення аудио та відео в чаті \ відкривання їх через intend
 ...
 таск 78. корректное отображение Прикреплённых к отправке файлов соответствующих типов. #//TODO TODODODO
