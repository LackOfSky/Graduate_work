...
------------------------------------------------------------------------------------------------------------
 ...
 todo:
    ...
    - фикс добавления в друзья
    - прописать отправку user info
    - добавить отправку реквеста на получение user info, если данные отсутствуют
    - фикс проблем с обновлением интерфейса
    - добавить систему уведомлений (на будущее)
    - сделать зануление  данных (списки друзей) при выключении сервиса
