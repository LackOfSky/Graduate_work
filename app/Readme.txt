...
(done) таск 4. разбирать друзей на активных и не активных (первым списком выводить друзей онлайн, вторым, всех в куче)
 ...
 таск 3. чистить список addFriends после добавления друга ( не добавлять друзей в список поиска друзей)
 ...
 таск 17. підтягувати userInfo для перегляду інших користувачів

 таск 18. при передачі картинки користувача виникає переповнення буферу. надсилати картинку окремим медіа-потоком

 таск 20. після додавання користувача в друзі вкладка addFriends не чиститься

 таск 21. щойно додані користувачі світяться як "оффлайн"

 таск 22. після видалення друга - відображати його у вкладці addFriends

 таск 23. delete for all (friends) з іншого пристрою користувач переходить в оффлайн замість видалення

 таск 24. перенести friends Online, friends offline в clientPartP2p
