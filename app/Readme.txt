...
v0.15.3
 ...
 (to check) таск 73. помилка надсилання медіа-лого. вказує данні файлу, що надсилались в перший раз
 ...
 таск 84. баг оновлення зображення логотипу друга. оновлюється лише один раз при коннекті до друга.
 ...
 таск 82. картка відображення повідомлення - якщо в повідомленні є reply message id, то ссилатися на те повідомлення
                (наразі вказано як AttachedReply(viewModel,Modifier) в MessageDialogItem )

 таск 83. передача медіа-повідомлень між користувачами.
                транспортна логіка.
 таск 72. відладити mediaServer. (Безпосередньо передачу медіа)
