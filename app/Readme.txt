...
v0.15.3
 таск 72. відладити mediaServer


 таск 73. помилка надсилання медіа-лого. вказує наче надсилає файл лише в перший раз
 ...
 таск 66. збереження медіа: логіка перевірки чи файл не повторюється (якщо файл з тим же ім'ям існує - перевірити його об'єм
            в пам'яті (якщо різний, то створити товий об'єкт, якщо однаковий - замінити\залишити як є)
 ...
 таск 74. баг клиента (при удалении клиента "только у себя", и второй нажал "удалить у всех" - клиент что нажал - отлетел

 таск 75. однобокое добавление userInfo. добавляет только тот, кто approve запрос
