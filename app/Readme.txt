...
v0.15.3
 ...
 таск 70. отправка медиа через чат, возможность просмотра видео в чате
 таск 71. отправка медиа через чат, возможность просмотра аудио в чате
 ...
 таск 79. фікс кнопки "пауза", що закриває огляд самого відео в відео карточці (повідомлення)

 таск 80. додати строку з відображенням поточного моменту відтворення для аудіо
